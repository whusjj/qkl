...
class Main:
    def __init__(self,filepath,deg_path):
        ...
        self.gnn_module = self.gnn_module.to(device)
...
if __name__ == "__main__":
    filepath = "/root/autodl-tmp/SAT-main/datasets/result/graph/raw/graph_list.npy"  # Placeholder path
    split_dict_filepath = '/root/autodl-tmp/SAT-main/datasets/result/graph/split_dict.pt'
    deg_path = '/root/autodl-tmp/SAT-main/datasets/result/deg.pt'
