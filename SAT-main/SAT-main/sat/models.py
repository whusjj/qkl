...
class GraphTransformer(nn.Module):
    def __init__(self, in_size, num_class, d_model, num_heads=8, epoch=2000,
                 dim_feedforward=512, dropout=0.0, num_layers=4, layers=6,batch_size = 128,
                 batch_norm=False, abs_pe=False, abs_pe_dim=0,train_length=10000,test_length = 1000,val_length = 1000,
        ...
        encoder_layer = TransformerEncoderLayer(
            d_model, num_heads, dim_feedforward, dropout, batch_norm=batch_norm, batch_size = batch_size,
            epoch=epoch,layers = layers,test_length = test_length,train_length=train_length,
            val_length=val_length,gnn_type=gnn_type, se=se, **kwargs)
